...
class DetailCatTypeActivity: BudgetApp() {
    override val navName = R.string.nav_detail_cat_type
    private var typeId: Int by mutableStateOf(0)
    ...
    private var allocated: Int by mutableStateOf(0)
    private var spent: Int by mutableStateOf(0)
    private var available: Int by mutableStateOf(0)
    ...
    override fun Content() {
        ...
        LaunchedEffect(Unit, block = {
            ...
            val detail = catTypeVM.detailCatTypes(typeId)
            if (detail != null) {
                type = detail.type
        ...
        Column(
            ...
            Row(
                ...
                Row(
                    ...
                    IconButton(
                        onClick = {
                            coroutineScope.launch {
                                val resSubmit = catTypeVM.deleteCatTypes(typeId)
                                if (resSubmit) {
                    ...
                    IconButton(
                        onClick = {
                            coroutineScope.launch {
                                val resSubmit = catTypeVM.updateCatTypes(
                                    typeId,
                                    AddCatType(
                                        type = type,
            ...
            Surface(
                ...
                Column(
                    ...
                    TextField(
                        modifier = Modifier.fillMaxWidth(),
                        label = { Text( text = "Current period amount allocated" ) },
                        value = "Rp. $allocated",
                        readOnly = true,
                        onValueChange = {  },
                        shape = MaterialTheme.shapes.medium,
                    ...
                    TextField(
                        modifier = Modifier.fillMaxWidth(),
                        label = { Text( text = "Current period  amount spent" ) },
                        value = "Rp. $spent",
                        readOnly = true,
                        onValueChange = {  },
                        shape = MaterialTheme.shapes.medium,
                    ...
                    TextField(
                        modifier = Modifier.fillMaxWidth(),
                        label = { Text( text = "Current period amount available" ) },
                        value = "Rp. $available",
                        readOnly = true,
                        onValueChange = {  },
                        shape = MaterialTheme.shapes.medium,
